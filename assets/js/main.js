/*
  PPI integration by J.Lam
  https://github.com/jimmykhlam/lens-jekyll-theme-instagram-without-api
  How to use: 
  1. Sign up for an account at https://profilepageimages.usecue.com
...
//main.init(); //For PPI integration we will defer the main.init() call until after thumbnails are fetched.

/*
PPI integration as follows
*/
fetch(jsonURL)
      ...
      data.forEach(function callback(object, index) {
        if (index < instagram_amount) {
          ...
          document.getElementById('thumbnails').innerHTML =
            ...
            image +
            "' data-position='left center'><img src='" +
            image_small +
            "' alt='' /></a><p>" +
            caption +
            "</p><p><a href='" +
            permalink +
            "'>View on Instagram</a></p><article>";
        }
      });
      resolve(true);
    });
